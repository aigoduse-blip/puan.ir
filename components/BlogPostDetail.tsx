...
const BlogPostDetail: React.FC = () => {
  ...
  if (!post) return <div className="pt-32 text-center">مقاله یافت نشد</div>;
          ...
          <article className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="p-8 md:p-12">
              <div className="flex flex-wrap gap-6 text-sm text-slate-500 mb-6">
                ...
                <span className="flex items-center gap-2 text-brand-gold"><Tag className="w-4 h-4" /> {post.category}</span>
              ...
              <div className="prose dark:prose-invert max-w-none prose-lg prose-slate">
                <p className="lead font-bold text-xl mb-6">{post.excerpt}</p>
                <p>
                  هوش مصنوعی در حال تغییر دادن تمامی جنبه‌های کسب‌وکار آنلاین در ایران است. در پلتفرم پوان، ما شاهد هستیم که چگونه استارتاپ‌های کوچک با استفاده از ایجنت‌های هوشمند، توانسته‌اند هزینه‌های عملیاتی خود را تا ۸۰ درصد کاهش دهند.
                </p>
                <h3 className="text-2xl font-bold mt-8 mb-4">چرا اتوماسیون ضروری است؟</h3>
                <p>
                  در بازار رقابتی امروز، پاسخگویی سریع به مشتریان یک مزیت نیست، بلکه یک ضرورت است. ابزارهایی مانند چت‌بات‌های پوان که به دیتابیس وردپرس متصل می‌شوند، می‌توانند در کسری از ثانیه موجودی کالا را چک کرده و به مشتری پاسخ دهند.
                </p>
                <div className="bg-brand-red/5 border-r-4 border-brand-red p-6 my-8 rounded-l-xl italic">
                ...
                <p>
                  برای شروع، نیازی به تغییر کل سیستم خود ندارید. می‌توانید با یک ایجنت ساده اینستاگرام شروع کنید که کامنت‌ها را پاسخ می‌دهد. سپس به سراغ سئوی خودکار بروید.
                </p>
              </div>

              <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-700 flex justify-between items-center">
                <div className="font-bold">اشتراک‌گذاری:</div>
